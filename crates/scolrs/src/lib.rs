...
mod tests {
    use crate::{
        ...
        RegionalCurveType, StructuralReason, Study, KYOPHOSIS_CURVE_MT, KYOPHOSIS_CURVE_PT,
        KYOPHOSIS_CURVE_TLL,
    };
    ...
    fn test_lenke_case1() -> Result<()> {
        ...
        let mut reason =
            MinorReason::with_coronal((IsStructural::T, curve_set.pt.as_ref().unwrap().1));
    ...
    fn test_lenke_case2() -> Result<()> {
        ...
        let mut reason =
            MinorReason::with_coronal((IsStructural::F, curve_set.mt.as_ref().unwrap().1));
        ...
        let mut reason =
            MinorReason::with_coronal((IsStructural::F, curve_set.pt.as_ref().unwrap().1));
